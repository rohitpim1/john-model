...
function showImg(picNum) {
  ...
  if (Number(picNum) == 1) {
    mod[0].style.background = "url('../assests/pic1.png')";
  
  } else if (Number(picNum) == 2) {
    mod[0].style.background = "url('../assests/pic2.png')";
  } else if (Number(picNum) == 3) {
    mod[0].style.background = "url('../assests/pic3.png')";
  } else if (Number(picNum) == 4) {
    mod[0].style.background = "url('../assests/pic4.png')";
  } else if (Number(picNum) == 5) {
    mod[0].style.background = "url('../assests/pic5.png')";
  } else {
    mod[0].style.background = "url('../assests/pic6.png')";
  }
}
